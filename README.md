...
| [2. 실행 방법](#3-실행-방법) | 설치 없이 바로 실행 |
| [3. 실행 화면](#4-실행-화면) | 실제 터미널 출력 |
| [4. 기능 목록](#5-기능-목록) | 메뉴 5개와 공통 입력 처리 |
| [5. 프로젝트 구조](#6-프로젝트-구조) | 파일 구성과 모듈 관계 |
| [6. 데이터 파일 (state.json)](#7-데이터-파일-statejson) | 저장 형식과 스키마 |
| [7. 설계 의도](#8-설계-의도) | "왜 이렇게 짰나"에 대한 답 |
| [8. 트러블슈팅](#9-트러블슈팅) | 실제로 막혔던 4가지 |
| [9. 학습 정리](#10-학습-정리) | Python · 클래스 · 파일입출력 · Git |
...
| 5 | 게임 실행 | 1~4번 실행, 종료 시 저장 후 종료 | [`run()`](quiz_game.py#L159) |
